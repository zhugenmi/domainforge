package com.domainforge.agent;

import com.domainforge.converter.ChatMessageConverter;
...
import com.domainforge.service.ChatMessageFacadeService;
...
public class DomainForge {
    ...
    public DomainForge(String agentId,
                     String name,
                     String description,
                     String systemPrompt,
