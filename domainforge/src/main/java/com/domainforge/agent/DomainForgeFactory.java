...
import com.domainforge.config.ChatClientRegistry;
...
@Component
public class DomainForgeFactory {

    private static final Logger log = LoggerFactory.getLogger(DomainForgeFactory.class);
    ...
    private DomainForge buildAgentRuntime(
            Agent agent,
            List<Message> memory,
     ...
     * 创建一个 DomainForge 实例
     */
    public DomainForge create(String agentId, String chatSessionId) {
